...
-(void) mapCommand: (GenericCommand *)cmd{
    ...
    switch (command_type) {
        ...
        case CommandType_CHANGE_PASSWORD_REQUEST:{
            NSLog(@"CommandType_CHANGE_PASSWORD_REQUESTREQUEST...");
            ChangePasswordResponse *chngpassword;
            if([[commandObj.trueResponseDict valueForKey:@"CHANGE_PASSWORD_REQUEST"] intValue]){
                chngpassword=[commandObj changePasswordResponseWithisSuccessful:YES reasonCode:0 reason:@"success"];
            }else{
                chngpassword=[commandObj changePasswordResponseWithisSuccessful:NO reasonCode:1 reason:@"failed"];
            }
        ...
        case CommandType_DELETE_ACCOUNT_REQUEST:{
            DeleteAccountResponse *delAcc;
            if([[commandObj.trueResponseDict valueForKey:@"DELETE_ACCOUNT_REQUEST"] intValue]){
                delAcc=[commandObj deleteAccountResponseWithisSuccessful:YES reasonCode:0 reason:@"success"];
            }else{
                delAcc=[commandObj deleteAccountResponseWithisSuccessful:NO reasonCode:1 reason:@"failed"];
            }
        ...
        case CommandType_USER_INVITE_REQUEST:{
            ...
            UserInviteResponse *invite;
            if([[commandObj.trueResponseDict valueForKey:@"USER_INVITE_REQUEST"] intValue]){
                invite = [commandObj userInviteResponseWithisSuccessful:YES internalIndex:[NSString stringWithFormat:@"%d" ,req.correlationId] reasonCode:0 reason:@"success"];
            }else{
                invite = [commandObj userInviteResponseWithisSuccessful:NO internalIndex:[NSString stringWithFormat:@"%d" ,req.correlationId] reasonCode:1 reason:@"failed"];
            }
        ...
        case CommandType_ALMOND_AFFILIATION_DATA_REQUEST:{
            NSLog(@"CommandType_ALMOND_AFFILIATION_DATA_REQUEST");
            NSMutableArray* accessEmailIDs_1 = [NSMutableArray arrayWithObjects:@"masood.pathan@securifi.com", @"masood@securifi.com", nil];
            SFIAlmondPlus *plus = [commandObj createAlmondPlusWithAlmondPlusName:@"almondplus_1" almondPlusMAC:@"251176217041064" index:1 colorCodeIndex:1 userCount:2 accessEmailIDs:accessEmailIDs_1 isExpanded:YES ownerEmailID:@"masood.pathan@securifi.com" linkType:0];
            NSMutableArray *list=[[NSMutableArray alloc]initWithObjects:plus, nil];
            
            AlmondAffiliationDataResponse *almondaffiliationResponse;
            if([[commandObj.trueResponseDict valueForKey:@"ALMOND_AFFILIATION_DATA_REQUEST"] intValue]){
                almondaffiliationResponse=[commandObj almondAffiliationDataResponseWithisSuccessful:YES almondCount:2 reason:@"success" almondList:list];
            }else{
                almondaffiliationResponse=[commandObj almondAffiliationDataResponseWithisSuccessful:NO almondCount:2 reason:@"failed" almondList:list];
            }

            [dc callDummyCloud:almondaffiliationResponse commandType:CommandType_ALMOND_AFFILIATION_DATA_RESPONSE];
            
            break;
        }
        case CommandType_USER_PROFILE_REQUEST:{
            NSLog(@"user profile request");
            UserProfileResponse *userResponse;
            if([[commandObj.trueResponseDict valueForKey:@"USER_PROFILE_REQUEST"] intValue]){
                userResponse = [commandObj userProfileResponseWithisSuccessful:YES firstName:@"firstName" lastName:@"lastName" addressLine1:@"addressLine1" addressLine2:@"addressLine2" addressLine3:@"addressLine3" country:@"INDIA" zipCode:@"516003" reasonCode:0 reason:@"success"];
            }else{
                userResponse = [commandObj userProfileResponseWithisSuccessful:NO firstName:@"firstName" lastName:@"lastName" addressLine1:@"addressLine1" addressLine2:@"addressLine2" addressLine3:@"addressLine3" country:@"INDIA" zipCode:@"516003" reasonCode:1 reason:@"failed"];
            }
        ...
        case CommandType_UPDATE_USER_PROFILE_REQUEST:{
            NSLog(@"CommandType_UPDATE_USER_PROFILE_REQUEST");
            UpdateUserProfileRequest *updatereq=cmd.command;
            UpdateUserProfileResponse *updateResp;
            if([[commandObj.trueResponseDict valueForKey:@"UPDATE_USER_PROFILE_REQUEST"] intValue]){
                updateResp= [commandObj updateUserProfileResponseWithisSuccessful:YES internalIndex:[NSString stringWithFormat:@"%d", updatereq.correlationId] reasonCode:0 reason:@"success"];
            }else{
                updateResp= [commandObj updateUserProfileResponseWithisSuccessful:NO internalIndex:[NSString stringWithFormat:@"%d", updatereq.correlationId] reasonCode:1 reason:@"failed"];
            }
            [dc callDummyCloud:updateResp commandType:CommandType_UPDATE_USER_PROFILE_RESPONSE];
            break;
        }
        case CommandType_ME_AS_SECONDARY_USER_REQUEST:{
            ...
            NSMutableArray *almondList=[[NSMutableArray alloc]initWithObjects:plus, nil];
            MeAsSecondaryUserResponse *secondaryuser;
            if([[commandObj.trueResponseDict valueForKey:@"ME_AS_SECONDARY_USER_REQUEST"] intValue]){
                secondaryuser=[commandObj meAsSecondaryUserResponseWithisSuccessful:YES reasonCode:0 reason:@"success" almondCount:1 almondList:almondList];
            }else{
                secondaryuser=[commandObj meAsSecondaryUserResponseWithisSuccessful:NO reasonCode:1 reason:@"failed" almondCount:1 almondList:almondList];
            }
        ...
        case CommandType_DELETE_SECONDARY_USER_REQUEST:{
            NSLog(@"CommandType_DELETE_SECONDARY_USER_REQUEST");
            DeleteSecondaryUserRequest *delsecreq=cmd.command;
            DeleteSecondaryUserResponse *delsecond;
            if([[commandObj.trueResponseDict valueForKey:@"DELETE_SECONDARY_USER_REQUEST"] intValue]){
                delsecond = [commandObj deleteSecondaryUserResponseWithisSuccessful:YES internalIndex:delsecreq.internalIndex reasonCode:0 reason:@"success"];
            }else{
                delsecond=[commandObj deleteSecondaryUserResponseWithisSuccessful:NO internalIndex:delsecreq.internalIndex reasonCode:1 reason:@"failed"];
            }
        ...
        case CommandType_DELETE_ME_AS_SECONDARY_USER_REQUEST:{
            NSLog(@"CommandType_DELETE_ME_AS_SECONDARY_USER_REQUEST");
            DeleteMeAsSecondaryUserRequest *delmereq=cmd.command;
            DeleteMeAsSecondaryUserResponse *delemteMeSecResponse;
            if([[commandObj.trueResponseDict valueForKey:@"DELETE_ME_AS_SECONDARY_USER_REQUEST"] intValue]){
                delemteMeSecResponse = [commandObj deleteMeAsSecondaryUserResponseWithisSuccessful:YES internalIndex:[NSString stringWithFormat:@"%d", delmereq.correlationId] reasonCode:0 reason:@"success"];
            }else{
                delemteMeSecResponse = [commandObj deleteMeAsSecondaryUserResponseWithisSuccessful:NO internalIndex:[NSString stringWithFormat:@"%d", delmereq.correlationId] reasonCode:1 reason:@"failed"];
            }

            [dc callDummyCloud:delemteMeSecResponse commandType:CommandType_DELETE_ME_AS_SECONDARY_USER_RESPONSE];
            break;
        }
        case CommandType_UNLINK_ALMOND_REQUEST:{
            NSLog(@"CommandType_UNLINK_ALMOND_REQUEST");
            UnlinkAlmondResponse *obj;
            if([[commandObj.trueResponseDict valueForKey:@"UNLINK_ALMOND_REQUEST"] intValue]){
                obj =[commandObj unlinkAlmondResponseWithisSuccessful:YES reasonCode:0 reason:@"success"];
            }else{
                obj =[commandObj unlinkAlmondResponseWithisSuccessful:NO reasonCode:1 reason:@"failed"];
            }
