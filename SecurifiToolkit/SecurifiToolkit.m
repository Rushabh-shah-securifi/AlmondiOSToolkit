...
+(id)initSDKCloud
{
    ...
    if(!cloudQueue){
        cloudQueue = dispatch_queue_create("cloud_connect_queue", DISPATCH_QUEUE_SERIAL );
    }
            ...
            switch (obj.commandType) {
                case LOGIN_COMMAND:
                {
                        ...
                        // if (0)
                    {
                        ...
                        NSDictionary *data = [NSDictionary dictionaryWithObject:object forKey:@"data"];
